...
const EditPersonalData = () => {
  ...
  return (
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="component-config">
     


    <div className="">
        <h3>Dados Pessoais</h3>
        <div className="container-config-personal">
        
        <div>
          <div className="container-input-config">
    ...
    <div className="container-config-end">
       ...
       <div>
        ...
        <div>
         <button type="submit" aria-label="Botão Registrar" className="btn-submite btn-config">Registrar</button> 
        </div>
